...
const snagSchema = z.object({
  ...
  category: z.enum([
    ...
    "Painting", "Finishing", "Waterproofing", "Other"
  ]),
  ...
  useEffect(() => {
    if (snag) {
      ...
      form.reset({
        ...
        severity: snag.severity as "critical" | "major" | "minor" | "cosmetic",
        category: validCategory,
        status: snag.status as "open" | "in_progress" | "resolved" | "requires_contractor" | "completed" | "rejected",
        location: snag.location,
        locationId: locationIdValue,
        assignedTo: snag.assignedTo,
        dueDate: snag.dueDate ? new Date(snag.dueDate) : undefined,
        // Advanced Snagging Module fields
        priority: (snag as any)?.priority as "high" | "medium" | "low" || "medium",
        assignedTeam: (snag as any)?.assignedTeam || "",
        estimatedCost: (snag as any)?.estimatedCost || "",
        subCategory: (snag as any)?.subCategory || "",
        remedialAction: (snag as any)?.remedialAction || "",
        inspectorNotes: (snag as any)?.inspectorNotes || "",
        clientVisible: (snag as any)?.clientVisible !== undefined ? (snag as any).clientVisible : true,
      });
    }
  }, [snag, form]);
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="e.g., Paint Chips, Light Fixtures" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  placeholder="Provide recommended action to resolve the issue"
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                ...
                                <FormDescription>
                                  When checked, this snag will be visible in client reports
                                </FormDescription>
                              </div>
                            </FormItem>
                          )}
